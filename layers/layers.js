...
var format_DelimitaomunicipaldoRSIBGE_4 = new ol.format.GeoJSON();
var features_DelimitaomunicipaldoRSIBGE_4 = format_DelimitaomunicipaldoRSIBGE_4.readFeatures(json_DelimitaomunicipaldoRSIBGE_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_DelimitaomunicipaldoRSIBGE_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_DelimitaomunicipaldoRSIBGE_4.addFeatures(features_DelimitaomunicipaldoRSIBGE_4);
var lyr_DelimitaomunicipaldoRSIBGE_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_DelimitaomunicipaldoRSIBGE_4, 
                style: style_DelimitaomunicipaldoRSIBGE_4,
                interactive: true,
                title: '<img src="styles/legend/DelimitaomunicipaldoRSIBGE_4.png" /> Delimitação municipal do RS [IBGE]'
            });
...
var format_Areas_Urbanas_6 = new ol.format.GeoJSON();
var features_Areas_Urbanas_6 = format_Areas_Urbanas_6.readFeatures(json_Areas_Urbanas_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Areas_Urbanas_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Areas_Urbanas_6.addFeatures(features_Areas_Urbanas_6);
var lyr_Areas_Urbanas_6 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Areas_Urbanas_6, 
                style: style_Areas_Urbanas_6,
                interactive: true,
                title: '<img src="styles/legend/Areas_Urbanas_6.png" /> Areas_Urbanas'
            });
...
lyr_ESRIShadedRelief_0.setVisible(true);lyr_ESRISatellite_1.setVisible(false);lyr_LimitesterritoriaisdoRioGrandedoSulIBGE_2.setVisible(true);lyr_LagoseLagoasFEPAM_3.setVisible(true);lyr_DelimitaomunicipaldoRSIBGE_4.setVisible(true);lyr_reasmidasFEPAM_5.setVisible(true);lyr_Areas_Urbanas_6.setVisible(true);lyr_RegiohidrogrficadoGuabaFEPAM_7.setVisible(true);lyr_RedededrenagemFEPAM_8.setVisible(true);lyr_TotaldeslidosemsuspensomgLmaro2019_9.setVisible(false);lyr_VolumedeefluentesdomsticosgLmaro2019_10.setVisible(false);
var layersList = [lyr_ESRIShadedRelief_0,lyr_ESRISatellite_1,lyr_LimitesterritoriaisdoRioGrandedoSulIBGE_2,lyr_LagoseLagoasFEPAM_3,lyr_DelimitaomunicipaldoRSIBGE_4,lyr_reasmidasFEPAM_5,lyr_Areas_Urbanas_6,lyr_RegiohidrogrficadoGuabaFEPAM_7,lyr_RedededrenagemFEPAM_8,lyr_TotaldeslidosemsuspensomgLmaro2019_9,lyr_VolumedeefluentesdomsticosgLmaro2019_10];
...
lyr_DelimitaomunicipaldoRSIBGE_4.set('fieldAliases', {'MSLINK': 'MSLINK', 'MAPID': 'MAPID', 'AREA_1': 'AREA_1', 'PERIMETRO_': 'PERIMETRO_', 'NOME': 'NOME', 'SEDE': 'SEDE', 'LATITUDESE': 'LATITUDESE', 'LONGITUDES': 'LONGITUDES', 'AREA_TOT_G': 'AREA_TOT_G', 'Cod_ibge': 'Cod_ibge', 'Label_N': 'Label_N', });
lyr_reasmidasFEPAM_5.set('fieldAliases', {'Hectares': 'Hectares', 'NOME': 'NOME', });
lyr_Areas_Urbanas_6.set('fieldAliases', {'AREA': 'AREA', 'PERIMETER': 'PERIMETER', 'Nome': 'Nome', 'Cod_IBGE': 'Cod_IBGE', });
...
lyr_DelimitaomunicipaldoRSIBGE_4.set('fieldImages', {'MSLINK': 'TextEdit', 'MAPID': 'TextEdit', 'AREA_1': 'TextEdit', 'PERIMETRO_': 'TextEdit', 'NOME': 'TextEdit', 'SEDE': 'Range', 'LATITUDESE': 'TextEdit', 'LONGITUDES': 'TextEdit', 'AREA_TOT_G': 'TextEdit', 'Cod_ibge': 'TextEdit', 'Label_N': 'TextEdit', });
lyr_reasmidasFEPAM_5.set('fieldImages', {'Hectares': 'TextEdit', 'NOME': 'TextEdit', });
lyr_Areas_Urbanas_6.set('fieldImages', {'AREA': 'TextEdit', 'PERIMETER': 'TextEdit', 'Nome': 'TextEdit', 'Cod_IBGE': 'TextEdit', });
...
lyr_LimitesterritoriaisdoRioGrandedoSulIBGE_2.set('fieldLabels', {'OBJECTID': 'no label', 'AREA': 'no label', 'PERIMETER': 'no label', 'RSLIMITELL': 'no label', 'RSLIMITE_1': 'no label', 'HA': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', });
lyr_LagoseLagoasFEPAM_3.set('fieldLabels', {'AREA': 'no label', 'PERIMETER': 'no label', 'RDPOL2_': 'no label', 'RDPOL2_ID': 'no label', 'NOME': 'no label', 'TRRE_ID': 'no label', });
lyr_DelimitaomunicipaldoRSIBGE_4.set('fieldLabels', {'MSLINK': 'no label', 'MAPID': 'no label', 'AREA_1': 'no label', 'PERIMETRO_': 'no label', 'NOME': 'no label', 'SEDE': 'no label', 'LATITUDESE': 'no label', 'LONGITUDES': 'no label', 'AREA_TOT_G': 'no label', 'Cod_ibge': 'no label', 'Label_N': 'no label', });
lyr_reasmidasFEPAM_5.set('fieldLabels', {'Hectares': 'no label', 'NOME': 'no label', });
lyr_Areas_Urbanas_6.set('fieldLabels', {'AREA': 'no label', 'PERIMETER': 'no label', 'Nome': 'no label', 'Cod_IBGE': 'no label', });
lyr_RegiohidrogrficadoGuabaFEPAM_7.set('fieldLabels', {'NOME_BACIA': 'no label', 'CODIGO_BAC': 'no label', 'REGIAO': 'no label', 'SIGLAS': 'no label', 'UPNxBH': 'no label', 'Ocup_máx': 'no label', 'area_maci': 'no label', 'distancia': 'no label', 'Hectares': 'no label', 'Area_max': 'no label', 'Area_max_Z': 'no label', });
lyr_RedededrenagemFEPAM_8.set('fieldLabels', {'FNODE_': 'no label', 'TNODE_': 'no label', 'LPOLY_': 'no label', 'RPOLY_': 'no label', 'LENGTH': 'no label', 'RH5256_': 'no label', 'RH5256_ID': 'no label', 'N_CARTA': 'no label', 'TREC_ID': 'no label', });
