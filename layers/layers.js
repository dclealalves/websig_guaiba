...
lyr_ESRISatellite_0.setVisible(true);lyr_LimitesterritoriaisdoRioGrandedoSulIBGE_1.setVisible(true);lyr_LagoseLagoasFEPAM_2.setVisible(true);lyr_DelimitaomunicipaldoRSIBGE_3.setVisible(true);lyr_reasmidasFEPAM_4.setVisible(true);lyr_Areas_Urbanas_5.setVisible(true);lyr_RegiohidrogrficadoGuabaFEPAM_6.setVisible(true);lyr_RedededrenagemFEPAM_7.setVisible(true);lyr_TotaldeslidosemsuspensomgLmaro2019_8.setVisible(true);lyr_VolumedeefluentesdomsticosgLmaro2019_9.setVisible(true);
