...
var style_RegiohidrogrficadoGuabaFEPAM_6 = function(feature, resolution){
    ...
    var style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(12,27,111,0.3)', lineDash: [10,5], lineCap: 'butt', lineJoin: 'miter', width: 0}),fill: new ol.style.Fill({color: 'rgba(129,176,246,0.3)'}),
